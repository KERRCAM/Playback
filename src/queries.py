...
class Queries:
    ...
    def __init__(self):
        ...
        self.username = ""
        self.most_listened = self.most_listened(10)
        self.most_streamed = self.most_streamed(10)
        self.most_played_artists = self.most_played_artists(10)
        self.most_skipped_songs = self.most_skipped_songs(10)
        self.top_artist_year = self.top_artist_year(0)
